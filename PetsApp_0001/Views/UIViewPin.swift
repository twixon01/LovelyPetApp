...
//  PetsApp_0001
//
//  Created by Илья Нестрогаев on 28.03.2024.
//
...
extension UIView {
    ...
    func pinCenterX(to anchor: NSLayoutXAxisAnchor,
                    _ const: Double = 0,
                    _ mode: ConstraintMode = .equal
    ) -> NSLayoutConstraint {
    ...
    private func pinConstraint<Axis: AnyObject, AnyAnchor: NSLayoutAnchor<Axis>>(
        ...
        case .grOE:result = firstAnchor.constraint(greaterThanOrEqualTo: secondAnchor, constant: const)
        case .lsOE:
